...
use crate::settings::{RuntimeAudioState, SettingsOpen};
use crate::widgets::{ButtonAction, PrimaryButton};
    ...
    for event in events.read() {
        match event {
            ...
            PauseMenuActionEvent::ExitToMainMenu => {
                modal_state.active = Some(crate::modal::ModalType::ConfirmMainMenu);
            }
