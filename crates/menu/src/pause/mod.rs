...
pub use PauseMenuPlugin as PausePlugin;

/// Marker state for pause menu transitions.
        ...
        app.init_resource::<state::PauseMenuState>()
            ...
            .add_systems(
                ...
                settings_bridge::update_settings_ui_bridge
                    .run_if(resource_changed::<launcher::config::UserSettings>)
                    .run_if(in_state(AppState::InGame))
                    .run_if(state::pause_settings_active),
            )
            .add_systems(
                Update,
                (
                    crate::widgets::slider_interaction_system,
                    crate::widgets::dropdown_interaction_system,
                    crate::widgets::dropdown_option_interaction_system,
                    crate::widgets::update_slider_visuals,
                )
                    .run_if(in_state(AppState::InGame))
                    .run_if(state::pause_settings_active),
            )
