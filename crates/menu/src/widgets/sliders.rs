...
use crate::events::{play_ui_audio, UiAudioEvent};
...
pub fn slider_interaction_system(
    ...
    runtime_audio: Res<crate::settings::RuntimeAudioState>,
...
fn apply_slider_setting(key: &SettingKey, value: f32, settings: &mut UserSettings) {
    match key {
