...
pub fn handle_menu_button_clicks(
    ...
    mut fade: ResMut<ScreenFade<AppState>>,
    mut modal_state: ResMut<crate::modal::ModalState>,
...
fn handle_button_action(
    ...
    fade: &mut ResMut<ScreenFade<AppState>>,
    modal_state: &mut crate::modal::ModalState,
    ...
    match action {
        ...
        ButtonAction::Exit => {
            ...
            modal_state.active = Some(crate::modal::ModalType::ConfirmExit);
        }
        ButtonAction::Back => {
