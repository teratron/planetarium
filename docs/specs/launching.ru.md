...
- **Изоляция**: Каждый язык хранится в своей поддиректории внутри `assets/locales/`.
...
│   ├── locales/            # Локализация (AAA файлы Fluent .ftl)
│   │   ├── en-US/          # Английский
│   │   │   ├── menu.ftl    # Тексты главного меню
│   │   │   ├── items.ftl   # Названия и описания предметов
│   │   │   └── dialogs.ftl # Тексты диалогов
│   │   ├── ru-RU/          # Русский
│   │   │   ├── menu.ftl
│   │   │   ├── items.ftl
│   │   │   └── dialogs.ftl
│   │   └── index.toml      # Манифест языков (список доступных локалей)
